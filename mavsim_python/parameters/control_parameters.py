...
wn_roll = 14
zeta_roll = 0.707
roll_kp = 0 # wn_roll**2/TF.a_phi2
roll_kd = 0 # (2*zeta_roll*wn_roll-TF.a_phi1)/TF.a_phi2

#----------course loop-------------
wn_course = 1.45
zeta_course = 0.707
course_kp = 0 # 2*zeta_course*wn_course*Va0/gravity
course_ki = 0 # wn_course**2*Va0/gravity
...
wn_altitude = 0.058
zeta_altitude = 0.707
altitude_kp = 0 #(2*zeta_altitude*wn_altitude)/(K_theta_DC*Va0)
altitude_ki = 0 #wn_altitude**2/(K_theta_DC*Va0)
altitude_zone = 10
